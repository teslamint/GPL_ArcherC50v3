...
#if defined CONFIG_MTD_PARTITION_SIZE_8M
...
#elif defined CONFIG_MTD_PARTITION_SIZE_4M
#define TP_BOOT_SIZE 		0x10000
#define TP_KERNEL_SIZE 		0x100000
#define TP_ROOTFS_SIZE		0x2d0000
#define TP_CONFIG_SIZE		0x10000
#define TP_ROMFILE_SIZE		0x10000
#define TP_ROM_SIZE			0x10000
#define TP_RADIO_SIZE		0x10000
...
#if defined CONFIG_MTD_PARTITION_SIZE_4M
static struct mtd_partition rt2880_partitions[] = {
    {
        name:		"boot",
	 size:		TP_BOOT_SIZE,/* 0x000000000000-0x000000020000  */
    ...
    {
        name:		"kernel",
	 size:		TP_KERNEL_SIZE,/* 0x000000020000-0x000000120000  */
	 offset:		TP_BOOT_SIZE,
    },
    {
        name:		"rootfs",
	 size:		TP_ROOTFS_SIZE,/* 0x000000120000-0x0000003d0000  */
	 offset:		TP_BOOT_SIZE + TP_KERNEL_SIZE,
    },
    {
        name:		"config",
	 size:		TP_CONFIG_SIZE, /* 0x0000003d0000-0x0000003e0000  */
	 offset:		TP_BOOT_SIZE + TP_KERNEL_SIZE + TP_ROOTFS_SIZE,
    },
    {
        name:		"rom",
	 size:		TP_ROM_SIZE,/* 0x0000003e0000-0x0000003f0000  */
	 offset:		TP_BOOT_SIZE + TP_KERNEL_SIZE + TP_ROOTFS_SIZE + TP_CONFIG_SIZE,
    },
    {
        name:		"radio",
	 size:		TP_RADIO_SIZE,/* 0x0000003f0000-0x000000400000  */
	 offset:		TP_BOOT_SIZE + TP_KERNEL_SIZE + TP_ROOTFS_SIZE +TP_CONFIG_SIZE + TP_ROM_SIZE,
    }
#else
static struct mtd_partition rt2880_partitions[] = {
    {
...
{
	if(spiflash_ioctl_read(l_buf, 0x7C0000, FLASH_MAX_RW_SIZE) < 0)
	{
		return -1;
	}
	...
	if(spiflash_ioctl_write(l_buf, 0x7C0000, 0x10000) < 0)
	{
