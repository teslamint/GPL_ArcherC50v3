...
/* modified by Red@Ralink, 2009/09/30 */
		...
		case RTPRIV_IOCTL_GET_CHANNEL_LIST:
			RTMP_AP_IoctlHandle(pAd, wrq, CMD_RTPRIV_IOCTL_GET_CHANNEL_LIST, 0, NULL, 0);
		    break;
...
/* end of modification */
		...
		case RTPRIV_IOCTL_GRATEINFO:
			//RTMPIoctlGRATEINFO((PRTMP_ADAPTER)pAd, wrq);
			RTMPIoctlGRATEINFO(pAd, wrqin);
			break;

		case RTPRIV_IOCTL_GBSSINFO:
			RTMP_AP_IoctlHandle(pAd, wrq, CMD_RTPRIV_IOCTL_GBSSINFO, 0, NULL, 0);
			break;
		case RTPRIV_IOCTL_GSTAINFO:
			RTMP_AP_IoctlHandle(pAd, wrq, CMD_RTPRIV_IOCTL_GSTAINFO, 0, NULL, 0);
			break;
		case RTPRIV_IOCTL_GSCANINFO:
			RTMP_AP_IoctlHandle(pAd, wrq, CMD_RTPRIV_IOCTL_GSCANINFO, 0, NULL, 0);
			break;
