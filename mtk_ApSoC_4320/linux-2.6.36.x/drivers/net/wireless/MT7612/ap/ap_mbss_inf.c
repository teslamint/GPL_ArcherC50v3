...
VOID RT28xx_MBSS_Init(VOID *pAd, PNET_DEV pDevMain)
{
	...
	netDevHook.xmit = MBSS_VirtualIF_PacketSend; /*rt28xx_send_packets; modified by wuguocheng*/ 	/* hard transmit hook point */
...
========================================================================
*/
INT MBSS_VirtualIF_PacketSend(struct sk_buff *skb, struct net_device *ndev)
{
	...
	return MBSS_PacketSend(skb, ndev, rt28xx_packet_xmit);
}
/* end added */
