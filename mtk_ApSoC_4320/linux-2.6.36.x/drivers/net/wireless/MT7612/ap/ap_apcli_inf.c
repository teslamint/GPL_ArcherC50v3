...
VOID RT28xx_ApCli_Init(VOID *pAd, PNET_DEV main_dev_p)
{
	...
	netDevOpHook.xmit = ApCli_VirtualIF_PacketSend; /*rt28xx_send_packets;*/ //modified by wuguocheng, 10Mar2016
...
========================================================================
*/
INT ApCli_VirtualIF_PacketSend(struct sk_buff *skb, struct net_device *ndev)
{
	...
	return APC_PacketSend(skb, ndev, rt28xx_packet_xmit);
