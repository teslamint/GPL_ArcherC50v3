...
#else
#define MAX_RX_PROCESS_CNT 	(RX_RING_SIZE) 	/*128	/*64 //32 /* (256)	/* (RX_RING_SIZE) */
#endif
...
#if (CONFIG_RT_SECOND_CARD == 7612)
//#if CONFIG_RTPCI_AP_RF_OFFSET == 0x48000	/* no CONFIG_RTPCI_AP_RF_OFFSET in config */
#define INF_MAIN_DEV_NAME		"rai"
#define INF_MBSSID_DEV_NAME		"rai"
#else
