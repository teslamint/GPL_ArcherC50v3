...
#else
#define DEFAULT_RF_OFFSET                                       0x7F8000
#endif
...
#else
#define EEPROM_DEFAULT_FILE_PATH                      "/etc/MT7612E_EEPROM.bin"
...
#else
#define EEPROM_FILE_DIR            "/etc/"
#define EEPROM_1ST_FILE_DIR        "/etc/"
#define EEPROM_2ND_FILE_DIR        "/etc/"
#endif /* CONFIG_SUPPORT_OPENWRT */

#define EEPROM_DEFULT_BIN_FILE		"MT7612E_EEPROM.bin"
#ifdef BB_SOC
#define BIN_FILE_PATH				"/etc/RT30xxEEPROM.bin"
#else
#define BIN_FILE_PATH				EEPROM_FILE_DIR""EEPROM_DEFULT_BIN_FILE
#endif /* BB_SOC */
