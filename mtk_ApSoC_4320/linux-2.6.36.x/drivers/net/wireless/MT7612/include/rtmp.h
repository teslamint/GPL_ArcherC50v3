...
/* yanglx: port from MT7610, for wps led */
...
#define DEFLAUT_PARTIAL_SCAN_BREAK_TIME	4  /* Period of partial scaning: unit: 100ms *//* Must be move to other place */
	...
	UCHAR AutoChannelSkipList[AUTO_SKIP_LIST_LEN];
	UCHAR DtimCount;	/* 0.. DtimPeriod-1 */
	UCHAR DtimPeriod;	/* default = 3 */
	UCHAR ErpIeContent;
...
typedef struct _MULTICAST_FILTER_TABLE_ENTRY {
	...
	UINT lastTime;
	PNET_DEV net_dev;
	MULTICAST_GROUP_ID groupId;	// UCHAR Addr[MAC_ADDR_LEN];
